...
var region_service_1 = __webpack_require__(/*! ../services/region.service */ "./src/app/layout/content/region/services/region.service.ts");
...
var RegionEditFormComponent = /** @class */ (function (_super) {
  ...
  */
    ...
    RegionEditFormComponent = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.Injector, region_service_1.RegionService,
            router_1.ActivatedRoute, ngx_ui_loader_1.NgxUiLoaderService])
    ], RegionEditFormComponent);
    return RegionEditFormComponent;
}(base_component_1.BaseComponent));
exports.RegionEditFormComponent = RegionEditFormComponent;
...
var RegionListComponent = /** @class */ (function (_super) {
    ...
    RegionListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.Injector, region_service_1.RegionService, core_1.ChangeDetectorRef,
...
var region_service_1 = __webpack_require__(/*! ./services/region.service */ "./src/app/layout/content/region/services/region.service.ts");
var region_form_component_1 = __webpack_require__(/*! ./components/region-form.component */ "./src/app/layout/content/region/components/region-form.component.ts");
var region_edit_form_component_1 = __webpack_require__(/*! ./components/region-edit-form.component */ "./src/app/layout/content/region/components/region-edit-form.component.ts");
var region_list_component_1 = __webpack_require__(/*! ./components/region-list.component */ "./src/app/layout/content/region/components/region-list.component.ts");
var forms_1 = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
...
var routes = [
    {
        ...
        children: [
            {
                path: '',
                component: region_list_component_1.RegionListComponent,
            },
            {
                path: 'create',
                component: region_form_component_1.RegionFormComponent,
            }, {
                path: 'edit/:Id',
                component: region_edit_form_component_1.RegionEditFormComponent,
            }, {
                path: '**',
                redirectTo: '',
            }
...
var RegionModule = /** @class */ (function () {
    ...
    RegionModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                region_list_component_1.RegionListComponent, region_form_component_1.RegionFormComponent, region_edit_form_component_1.RegionEditFormComponent
            ],
            providers: [
