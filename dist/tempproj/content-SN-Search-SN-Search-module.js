...
var SN_Search_1 = __webpack_require__(/*! ./services/SN-Search */ "./src/app/layout/content/SN-Search/services/SN-Search.ts");
var SN_Search_2 = __webpack_require__(/*! ./components/SN-Search */ "./src/app/layout/content/SN-Search/components/SN-Search.ts");
...
var routes = [
    {
        ...
        children: [
            {
                path: "",
                component: SN_Search_2.SNSearchComponent,
            },
            {
                path: "**",
                redirectTo: "",
...
var SNSearchModule = /** @class */ (function () {
    ...
    SNSearchModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                SN_Search_2.SNSearchComponent
            ],
            providers: [
                excel_file_service_1.ExporterService,
                SN_Search_1.SNSearchService
            ],
            entryComponents: []
        })
    ], SNSearchModule);
...
exports.SNSearchModule = SNSearchModule;
...
var SNSearchComponent = /** @class */ (function (_super) {
    ...
    SNSearchComponent = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.Injector, http_1.HttpClient, SN_Search_1.SNSearchService, excel_file_service_1.ExporterService,
...
exports.SNSearchComponent = SNSearchComponent;
...
exports.SNSearchService = SNSearchService;
