...
var Dispatch_Activity_1 = __webpack_require__(/*! ../service/Dispatch-Activity */ "./src/app/layout/content/dispatch-activity/service/Dispatch-Activity.ts");
...
var DispatchActivityComponent = /** @class */ (function (_super) {
    ...
    DispatchActivityComponent = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.Injector, http_1.HttpClient, Dispatch_Activity_1.DispatchActivityService,
            forms_1.FormBuilder, ngx_ui_loader_1.NgxUiLoaderService, ngb_modal_1.ModalManager, core_1.ChangeDetectorRef, core_1.ChangeDetectorRef])
    ], DispatchActivityComponent);
    return DispatchActivityComponent;
}(base_component_1.BaseComponent));
exports.DispatchActivityComponent = DispatchActivityComponent;
...
var Dispatch_Activity_1 = __webpack_require__(/*! ./service/Dispatch-Activity */ "./src/app/layout/content/dispatch-activity/service/Dispatch-Activity.ts");
var Dispatch_Activity_2 = __webpack_require__(/*! ./components/Dispatch-Activity */ "./src/app/layout/content/dispatch-activity/components/Dispatch-Activity.ts");
var forms_1 = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
...
var routes = [
    {
        ...
        children: [
            {
                path: "",
                component: Dispatch_Activity_2.DispatchActivityComponent,
            },
            {
                path: "**",
                redirectTo: "",
...
var DispatchActivityModule = /** @class */ (function () {
    ...
    DispatchActivityModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                Dispatch_Activity_2.DispatchActivityComponent
            ],
            providers: [
                Dispatch_Activity_1.DispatchActivityService
            ],
            entryComponents: []
        })
...
exports.DispatchActivityModule = DispatchActivityModule;
...
exports.DispatchActivityService = DispatchActivityService;
...
module.exports = "td{text-align:center}th{text-align:center}\n"
