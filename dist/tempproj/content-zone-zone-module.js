(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["content-zone-zone-module"],{
...
/***/ "./src/app/layout/content/zone/components/zone-edit-form.component.ts":
/*!****************************************************************************!*\
  !*** ./src/app/layout/content/zone/components/zone-edit-form.component.ts ***!
  \****************************************************************************/
/*! exports provided: ZoneEditFormComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ZoneEditFormComponent", function() { return ZoneEditFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _services_zone_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/zone.service */ "./src/app/layout/content/zone/services/zone.service.ts");
...
var ZoneEditFormComponent = /** @class */ (function (_super) {
    __extends(ZoneEditFormComponent, _super);
    function ZoneEditFormComponent(injector, _regionService, activeRoute, ngxService) {
    ...
    ZoneEditFormComponent.prototype.ngOnInit = function () {
    ...
    ZoneEditFormComponent.prototype.getProvinceValue = function (item) {
        this.provinceValue = item.Value;
    };
    ZoneEditFormComponent.prototype.getProvinceKeyPair = function () {
        var _this = this;
    ...
    ZoneEditFormComponent.prototype.getProvinceNameFromProvinceKeyPair = function (provinceId) {
    ...
    ZoneEditFormComponent.prototype.getById = function () {
        var _this = this;
    ...
    ZoneEditFormComponent.prototype.onStatusChange = function (eve) {
        this.status = eve;
    };
    /**
  * The following method is used to add the form validations
  */
    ZoneEditFormComponent.prototype.addFormValidations = function () {
    ...
    ZoneEditFormComponent.prototype.updateRegion = function (regionFormValue) {
        if (this.formGroup.valid) {
            this.executeRegionUpdate(regionFormValue);
        }
    };
    ZoneEditFormComponent.prototype.executeRegionUpdate = function (regionFormValue) {
        var _this = this;
    ...
    ZoneEditFormComponent.prototype.validateControl = function (controlName) {
     ...
     * @returns {string}
     */
    ZoneEditFormComponent.prototype.getErrorMessage = function (formElement) {
    ...
    ZoneEditFormComponent.prototype.redirectToRegionList = function () {
        this.router.navigate([this.routesList.REGION_LISTING]);
    };
    ZoneEditFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'wms-edit-zone-form',
            template: __webpack_require__(/*! ../templates/edit-form.component.html */ "./src/app/layout/content/zone/templates/edit-form.component.html"),
            styles: [__webpack_require__(/*! ../styles/zone-form.component.scss */ "./src/app/layout/content/zone/styles/zone-form.component.scss")],
        }),
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"], _services_zone_service__WEBPACK_IMPORTED_MODULE_2__["ZoneService"],
...
/***/ "./src/app/layout/content/zone/components/zone-form.component.ts":
/*!***********************************************************************!*\
  !*** ./src/app/layout/content/zone/components/zone-form.component.ts ***!
  \***********************************************************************/
/*! exports provided: ZoneFormComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ZoneFormComponent", function() { return ZoneFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _services_zone_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/zone.service */ "./src/app/layout/content/zone/services/zone.service.ts");
/* harmony import */ var src_app_helpers_components_base_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/helpers/components/base.component */ "./src/app/helpers/components/base.component.ts");
...
var ZoneFormComponent = /** @class */ (function (_super) {
    ...
    function ZoneFormComponent(injector, _zoneService, activeRoute) {
        var _this = _super.call(this, injector) || this;
        _this._zoneService = _zoneService;
        _this.activeRoute = activeRoute;
        _this.provinceValue = {};
        _this.regionValue = {};
        _this.provinceDropdownSettings = {};
    ...
    ZoneFormComponent.prototype.getProvinceValue = function (item) {
        this.provinceValue = item.Value;
        this.getRegionKeyPair(item.Value);
    };
    ZoneFormComponent.prototype.getRegionValue = function (item) {
        this.regionValue = item.Value;
    };
    ZoneFormComponent.prototype.getProvinceKeyPair = function () {
        var _this = this;
        debugger;
        var companyBusinessUnitInfo = {
            CompanyId: this.localStorageService.getCompanyId(),
    ...
    ZoneFormComponent.prototype.getRegionKeyPair = function (selectedProject) {
        var _this = this;
        debugger;
        var companyBusinessUnitInfo = {
            ProvinceId: this.provinceValue
  ...
  * The following method is used to add the form validations
  */
    ZoneFormComponent.prototype.addFormValidations = function () {
        var requiredValidation = [
            _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required,
        ];
        this.addFormControlWithValidations("Name", requiredValidation);
    ...
    ZoneFormComponent.prototype.createZone = function (zoneFormValue) {
        if (this.formGroup.valid) {
            this.executeZoneCreation(zoneFormValue);
        }
    };
    ZoneFormComponent.prototype.executeZoneCreation = function (zoneFormValue) {
        var _this = this;
        var zone = {
            StatusId: this.status ? '1' : '0',
        ...
        var apiUrl = this.apiConstant.ZONE_CREATE;
        this._zoneService.create(apiUrl, zone)
            .subscribe(function (res) {
            _this.showToastrSuccess('Zone created successfully');
            setTimeout(function () {
                _this.clearFields();
            }, 1000);
        }, (function (error) {
    ...
    ZoneFormComponent.prototype.clearFields = function () {
        this.formGroup.get("ProvinceId").setValue('');
        this.formGroup.get("RegionId").setValue('');
        this.formGroup.get("Name").setValue('');
    };
    ZoneFormComponent.prototype.validateControl = function (controlName) {
        if (this.formGroup.controls[controlName].invalid && this.formGroup.controls[controlName].touched)
            return true;
        return false;
    };
     ...
     * @returns {string}
     */
    ZoneFormComponent.prototype.getErrorMessage = function (formElement) {
        // if any errors detected else ignore
        var control = this.formGroup.get(formElement);
        if (control.errors) {
            if (control.errors.required) {
    ...
    ZoneFormComponent.prototype.redirectToZoneList = function () {
        this.router.navigate([this.routesList.ZONE_LISTING]);
    };
    ZoneFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'wms-zone-form',
            template: __webpack_require__(/*! ../templates/form.component.html */ "./src/app/layout/content/zone/templates/form.component.html"),
            styles: [__webpack_require__(/*! ../styles/zone-form.component.scss */ "./src/app/layout/content/zone/styles/zone-form.component.scss")],
        }),
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"], _services_zone_service__WEBPACK_IMPORTED_MODULE_2__["ZoneService"],
...
/***/ "./src/app/layout/content/zone/components/zone-list.component.ts":
/*!***********************************************************************!*\
  !*** ./src/app/layout/content/zone/components/zone-list.component.ts ***!
  \***********************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_zone_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/zone.service */ "./src/app/layout/content/zone/services/zone.service.ts");
...
var ZoneListComponent = /** @class */ (function (_super) {
    __extends(ZoneListComponent, _super);
    function ZoneListComponent(injector, _zoneService, chRef, exporterService, ngxService) {
        var _this = _super.call(this, injector) || this;
        _this._zoneService = _zoneService;
        _this.chRef = chRef;
    ...
    ZoneListComponent.prototype.getAll = function () {
        var _this = this;
        this.ngxService.start();
        var companyBusinessUnitInfo = {
            CompanyId: this.localStorageService.getCompanyId(),
        ...
        var apiAddress = this.apiConstant.ZONE_LIST;
        this._zoneService.getKeyPair(apiAddress, companyBusinessUnitInfo)
            .subscribe(function (res) {
            debugger;
            _this.zoneList = res;
    ...
    ZoneListComponent.prototype.Edit = function (id) {
        var updateUrl = this.routesList.REGION_EDIT + ("/" + id);
        this.router.navigate([updateUrl]);
    };
    ZoneListComponent.prototype.exportServiceAsExcel = function () {
        var _this = this;
    ...
    ZoneListComponent.prototype.redirectToCreateZone = function () {
        this.router.navigate([this.routesList.ZONE_CREATE]);
    };
    ZoneListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'wms-region-list',
            template: __webpack_require__(/*! ../templates/list.component.html */ "./src/app/layout/content/zone/templates/list.component.html"),
            styles: [__webpack_require__(/*! ../styles/zone-form.component.scss */ "./src/app/layout/content/zone/styles/zone-form.component.scss")],
        }),
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"], _services_zone_service__WEBPACK_IMPORTED_MODULE_1__["ZoneService"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
...
/***/ "./src/app/layout/content/zone/services/zone.service.ts":
/*!**************************************************************!*\
  !*** ./src/app/layout/content/zone/services/zone.service.ts ***!
  \**************************************************************/
...
/***/ "./src/app/layout/content/zone/styles/zone-form.component.scss":
/*!*********************************************************************!*\
  !*** ./src/app/layout/content/zone/styles/zone-form.component.scss ***!
  \*********************************************************************/
...
/***/ "./src/app/layout/content/zone/templates/edit-form.component.html":
/*!************************************************************************!*\
  !*** ./src/app/layout/content/zone/templates/edit-form.component.html ***!
  \************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/layout/content/zone/templates/form.component.html":
/*!*******************************************************************!*\
  !*** ./src/app/layout/content/zone/templates/form.component.html ***!
  \*******************************************************************/
/*! no static exports found */
...
module.exports = "<section class=\"content\">\r\n    <section class=\"content-header\">\r\n      <h1>\r\n        CREATE ZONE\r\n      </h1>\r\n      <ol class=\"breadcrumb\">\r\n        <li><a href=\"#\"><i class=\"fa fa-dashboard\"></i> Home</a></li>\r\n        <li><a routerLink=\"[this.routesList.ZONE_LISTING]\">Zone</a></li>\r\n        <li class=\"active\">Create</li>\r\n      </ol>\r\n    </section>\r\n    \r\n    <div col-md-12>\r\n      <form name=\"formGroup\" [formGroup]=\"formGroup\" novalidate (ngSubmit)=\"createZone(formGroup.value)\">\r\n        <div class=\"box box-primary\">\r\n          <div class=\"box-header with-border\">\r\n            <div class=\"form-group  pull-right\">\r\n                <button type=\"button\" (click)=\"redirectToZoneList()\" class=\"btn-wms\">Zone Listing</button>\r\n            </div>\r\n          </div>\r\n          <div class=\"box-body\">\r\n            <div class=\"col-md-12\">\r\n              <div class=\"col-md-4\">\r\n                <div class=\"form-group\">\r\n                  <label>Province</label>\r\n                  <ng-multiselect-dropdown [placeholder]=\"'Select one'\"\r\n                  [data]=\"provencesKeyPair\" [settings]=\"provinceDropdownSettings\"\r\n                  formControlName=\"ProvinceId\"\r\n                  (onSelect)=\"getProvinceValue($event)\">\r\n                  </ng-multiselect-dropdown>\r\n                  <span class=\"help-block\" *ngIf=\"formGroup.controls.ProvinceId.invalid\">\r\n                    {{getErrorMessage('ProvinceId')}}\r\n                  </span>\r\n                </div>\r\n              </div>\r\n                <div class=\"col-md-4\">\r\n                  <div class=\"form-group\">\r\n                    <label>Region</label>\r\n                   \r\n                    <ng-multiselect-dropdown [placeholder]=\"'Select one'\"\r\n                    [data]=\"regionKeyPair\"\r\n                    [settings]=\"regionDropdownSettings\"\r\n                    formControlName=\"RegionId\"\r\n                    (onSelect)=\"getRegionValue($event)\">\r\n                    </ng-multiselect-dropdown>\r\n                    <span class=\"help-block\" *ngIf=\"formGroup.controls.RegionId.invalid\">\r\n                      {{getErrorMessage('RegionId')}}\r\n                    </span>\r\n                  </div>\r\n                </div>\r\n              \r\n                <div class=\"col-md-4\">\r\n                  <div class=\"form-group\">\r\n                    <label>Zone Name</label>\r\n                    <input type=\"text\" formControlName=\"Name\" class=\"form-control input-sm\" placeholder=\"Enter Zone Name\">\r\n                    <span class=\"help-block\" *ngIf=\"formGroup.controls.Name.invalid\">\r\n                      {{getErrorMessage('Name')}}\r\n                    </span>\r\n                  </div>\r\n                </div>\r\n            </div>\r\n          </div>\r\n\r\n          <div class=\"box-footer\">\r\n              <button type=\"submit\" [disabled]=\"formGroup.invalid\" class=\"btn btn-success pull-right\">S U B M I T</button>\r\n          </div>\r\n        </div>\r\n      </form>\r\n    </div>\r\n  </section>\r\n"

/***/ }),

/***/ "./src/app/layout/content/zone/templates/list.component.html":
/*!*******************************************************************!*\
  !*** ./src/app/layout/content/zone/templates/list.component.html ***!
  \*******************************************************************/
/*! no static exports found */
...
module.exports = "<section class=\"content\">\r\n    <section class=\"content-header\">\r\n        <h1>\r\n          ZONE LISTING\r\n          <small>\r\n            <button class=\"btn-wms\" (click)=\"redirectToCreateZone()\"><i class=\"fa fa-plus-circle\"></i></button>\r\n          </small>\r\n        </h1>\r\n        <ol class=\"breadcrumb\">\r\n          <li><a href=\"#\"><i class=\"fa fa-dashboard\"></i> Home</a></li>\r\n          <li><a routerLink=\"[this.routesList.ZONE_LISTING]\">Zone</a></li>\r\n          <li class=\"active\">Listing</li>\r\n        </ol>\r\n      </section>\r\n\r\n      <div class=\"pull-right\">\r\n        <button class=\"btn-excel\" (click)=\"exportServiceAsExcel()\"><i class=\"fa fa-file-excel-o\"></i></button>\r\n      </div>\r\n      \r\n  <div class=\"row\">\r\n    <div class=\"col-xs-12\">\r\n      <div class=\"box box-solid\">\r\n        <div class=\"box-header\">\r\n          <!-- <h3 class=\"box-title\">Hover Data Table</h3> -->\r\n        </div>\r\n        <!-- /.box-header -->\r\n        <div class=\"box-body\">\r\n          <div id=\"example2_wrapper\" class=\"dataTables_wrapper form-inline dt-bootstrap\">\r\n            <div class=\"row\">\r\n              <div class=\"col-sm-12 table-responsive\">\r\n                <table class=\"table table-bordered table-hover dataTable\" role=\"grid\">\r\n                  <thead>\r\n                    <tr role=\"row\">\r\n                      <th>Sr.</th>\r\n                      <th>Province Name</th>\r\n                      <th>Region Name</th>\r\n                      <th>Zone Name</th>\r\n                      <th>Actions</th>\r\n                    </tr>\r\n                  </thead>\r\n                  <tbody>\r\n                    <tr role=\"row\" *ngFor=\"let zone of zoneList; let i = index\">\r\n                      <td>{{i+1}}</td>\r\n                      <td>{{zone.AML_Province.Name}}</td>\r\n                      <td>{{zone.AML_Region.Name}}</td>\r\n                      <td>{{zone.ZoneName}}</td>\r\n                      <td>\r\n                        <button type=\"button\" id=\"update\" class=\"editBtn btn-warning\" (click)=\"Edit(zone.ZoneId)\"><i\r\n                            class=\"fa fa-edit\"></i></button>\r\n                      </td>\r\n                    </tr>\r\n                  </tbody>\r\n                  <ngx-ui-loader></ngx-ui-loader>\r\n                </table>\r\n              </div>\r\n            </div>\r\n     \r\n          </div>\r\n        </div>\r\n        <!-- /.box-body -->\r\n      </div>\r\n      <!-- /.box -->\r\n    </div>\r\n    <!-- /.col -->\r\n  </div>\r\n  <!-- /.row -->\r\n</section>"

/***/ }),

/***/ "./src/app/layout/content/zone/zone.module.ts":
/*!****************************************************!*\
  !*** ./src/app/layout/content/zone/zone.module.ts ***!
  \****************************************************/
...
/* harmony import */ var _services_zone_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/zone.service */ "./src/app/layout/content/zone/services/zone.service.ts");
/* harmony import */ var _components_zone_form_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/zone-form.component */ "./src/app/layout/content/zone/components/zone-form.component.ts");
/* harmony import */ var _components_zone_edit_form_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/zone-edit-form.component */ "./src/app/layout/content/zone/components/zone-edit-form.component.ts");
/* harmony import */ var _components_zone_list_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/zone-list.component */ "./src/app/layout/content/zone/components/zone-list.component.ts");
...
var routes = [
    {
        ...
        children: [
            {
                path: '',
                component: _components_zone_list_component__WEBPACK_IMPORTED_MODULE_7__["ZoneListComponent"],
            },
            {
                path: 'create',
                component: _components_zone_form_component__WEBPACK_IMPORTED_MODULE_5__["ZoneFormComponent"],
            }, {
                path: 'edit/:Id',
                component: _components_zone_edit_form_component__WEBPACK_IMPORTED_MODULE_6__["ZoneEditFormComponent"],
            }, {
                path: '**',
                redirectTo: '',
            }
...
var ZoneModule = /** @class */ (function () {
    ...
    ZoneModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _components_zone_list_component__WEBPACK_IMPORTED_MODULE_7__["ZoneListComponent"], _components_zone_form_component__WEBPACK_IMPORTED_MODULE_5__["ZoneFormComponent"], _components_zone_edit_form_component__WEBPACK_IMPORTED_MODULE_6__["ZoneEditFormComponent"]
            ],
            providers: [
...
//# sourceMappingURL=content-zone-zone-module.js.map