...
/*!***************************************************************************************************************************!*\
  !*** ./src/app/layout/content/shipment-note-moving-warehouse/components/shipment-note-moving-warehouse-edit.component.ts ***!
  \***************************************************************************************************************************/
/*! exports provided: ShipmentNoteMovingWarehouseEditComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShipmentNoteMovingWarehouseEditComponent", function() { return ShipmentNoteMovingWarehouseEditComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_shipment_note_moving_warehouse_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/shipment-note-moving-warehouse.service */ "./src/app/layout/content/shipment-note-moving-warehouse/services/shipment-note-moving-warehouse.service.ts");
...
var ShipmentNoteMovingWarehouseEditComponent = /** @class */ (function (_super) {
    ...
    ShipmentNoteMovingWarehouseEditComponent.prototype.OpenModal = function () {
        jquery__WEBPACK_IMPORTED_MODULE_3__('#shipModal').show();
        //this.loadComponent = true;
    };
    ShipmentNoteMovingWarehouseEditComponent.prototype.CloseModal = function () {
        jquery__WEBPACK_IMPORTED_MODULE_3__('#shipModal').hide();
        this.redirectToListShipmentNote();
    ...
    ShipmentNoteMovingWarehouseEditComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"], _services_shipment_note_moving_warehouse_service__WEBPACK_IMPORTED_MODULE_1__["ShipmentNoteService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_7__["ActivatedRoute"],
            ngx_ui_loader__WEBPACK_IMPORTED_MODULE_11__["NgxUiLoaderService"],
            src_app_helpers_services_excel_file_service__WEBPACK_IMPORTED_MODULE_8__["ExporterService"],
            src_app_helpers_services_environment_url_service__WEBPACK_IMPORTED_MODULE_9__["EnvironmentUrlService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HttpClient"]])
...
/*!***************************************************************************************************************************!*\
  !*** ./src/app/layout/content/shipment-note-moving-warehouse/components/shipment-note-moving-warehouse-list.component.ts ***!
  \***************************************************************************************************************************/
/*! exports provided: ShipmentNoteMovingWarehouseListComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShipmentNoteMovingWarehouseListComponent", function() { return ShipmentNoteMovingWarehouseListComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_shipment_note_moving_warehouse_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/shipment-note-moving-warehouse.service */ "./src/app/layout/content/shipment-note-moving-warehouse/services/shipment-note-moving-warehouse.service.ts");
/* harmony import */ var src_app_helpers_components_base_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/helpers/components/base.component */ "./src/app/helpers/components/base.component.ts");
...
var ShipmentNoteMovingWarehouseListComponent = /** @class */ (function (_super) {
    ...
    ShipmentNoteMovingWarehouseListComponent.prototype.OpenModal = function () {
        jquery__WEBPACK_IMPORTED_MODULE_4__('#shipModal').show();
        //this.loadComponent = true;
    };
    ShipmentNoteMovingWarehouseListComponent.prototype.CloseModal = function () {
        debugger;
        jquery__WEBPACK_IMPORTED_MODULE_4__('#shipModal').hide();
        //this.redirectToListShipmentNote()
        // this.loadComponent = false;
    };
...
/*!********************************************************************************************************!*\
  !*** ./src/app/layout/content/shipment-note-moving-warehouse/shipment-note-moving-warehouse.module.ts ***!
  \********************************************************************************************************/
/*! exports provided: ShipmentNoteMovingWarehouseModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShipmentNoteMovingWarehouseModule", function() { return ShipmentNoteMovingWarehouseModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _services_shipment_note_moving_warehouse_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/shipment-note-moving-warehouse.service */ "./src/app/layout/content/shipment-note-moving-warehouse/services/shipment-note-moving-warehouse.service.ts");
/* harmony import */ var _components_shipment_note_moving_warehouse_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/shipment-note-moving-warehouse-list.component */ "./src/app/layout/content/shipment-note-moving-warehouse/components/shipment-note-moving-warehouse-list.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
...
/* harmony import */ var _components_shipment_note_moving_warehouse_edit_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/shipment-note-moving-warehouse-edit.component */ "./src/app/layout/content/shipment-note-moving-warehouse/components/shipment-note-moving-warehouse-edit.component.ts");
...
var routes = [
    {
        ...
        children: [
            {
                path: "",
                component: _components_shipment_note_moving_warehouse_list_component__WEBPACK_IMPORTED_MODULE_5__["ShipmentNoteMovingWarehouseListComponent"],
            },
            // {
            //   path: "create",
            ...
            {
                path: "edit/:Id",
                component: _components_shipment_note_moving_warehouse_edit_component__WEBPACK_IMPORTED_MODULE_9__["ShipmentNoteMovingWarehouseEditComponent"],
            },
            {
                path: "**",
                redirectTo: "",
...
var ShipmentNoteMovingWarehouseModule = /** @class */ (function () {
    ...
    ShipmentNoteMovingWarehouseModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _components_shipment_note_moving_warehouse_list_component__WEBPACK_IMPORTED_MODULE_5__["ShipmentNoteMovingWarehouseListComponent"], _components_shipment_note_moving_warehouse_edit_component__WEBPACK_IMPORTED_MODULE_9__["ShipmentNoteMovingWarehouseEditComponent"]
            ],
            providers: [
                _services_shipment_note_moving_warehouse_service__WEBPACK_IMPORTED_MODULE_4__["ShipmentNoteService"],
