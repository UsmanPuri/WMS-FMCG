...
var move_stock_service_1 = __webpack_require__(/*! ../services/move-stock.service */ "./src/app/layout/content/move-stock/services/move-stock.service.ts");
...
var MoveStockComponent = /** @class */ (function (_super) {
  ...
  */
    ...
    MoveStockComponent = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.Injector, move_stock_service_1.MoveStockService,
            ngb_modal_1.ModalManager])
    ], MoveStockComponent);
    return MoveStockComponent;
}(base_component_1.BaseComponent));
exports.MoveStockComponent = MoveStockComponent;
...
var move_stock_service_1 = __webpack_require__(/*! ./services/move-stock.service */ "./src/app/layout/content/move-stock/services/move-stock.service.ts");
var move_stock_1 = __webpack_require__(/*! ./components/move-stock */ "./src/app/layout/content/move-stock/components/move-stock.ts");
var forms_1 = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
...
var routes = [
    {
        ...
        children: [
            {
                path: "",
                component: move_stock_1.MoveStockComponent,
            },
            {
                path: "**",
                redirectTo: "",
...
var MoveStockModule = /** @class */ (function () {
    ...
    MoveStockModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                move_stock_1.MoveStockComponent
            ],
            providers: [
                move_stock_service_1.MoveStockService
            ],
            entryComponents: []
        })
    ], MoveStockModule);
...
exports.MoveStockModule = MoveStockModule;
...
exports.MoveStockService = MoveStockService;
