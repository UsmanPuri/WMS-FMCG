...
var transfer_order_service_1 = __webpack_require__(/*! ../services/transfer-order.service */ "./src/app/layout/content/transfer-order/services/transfer-order.service.ts");
...
var TransferOrderFormComponent = /** @class */ (function (_super) {
    ...
    TransferOrderFormComponent = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.Injector,
            router_1.ActivatedRoute, excel_file_service_1.ExporterService, transfer_order_service_1.TransferOrderService, environment_url_service_1.EnvironmentUrlService, http_1.HttpClient])
    ], TransferOrderFormComponent);
    return TransferOrderFormComponent;
}(base_component_1.BaseComponent));
exports.TransferOrderFormComponent = TransferOrderFormComponent;
...
exports.TransferOrderListComponent = TransferOrderListComponent;
...
exports.TransferOrderService = TransferOrderService;
...
var excel_file_service_1 = __webpack_require__(/*! src/app/helpers/services/excel-file.service */ "./src/app/helpers/services/excel-file.service.ts");
var transfer_order_form_component_1 = __webpack_require__(/*! ./components/transfer-order-form.component */ "./src/app/layout/content/transfer-order/components/transfer-order-form.component.ts");
var transfer_order_list_component_1 = __webpack_require__(/*! ./components/transfer-order-list.component */ "./src/app/layout/content/transfer-order/components/transfer-order-list.component.ts");
var transfer_order_service_1 = __webpack_require__(/*! ./services/transfer-order.service */ "./src/app/layout/content/transfer-order/services/transfer-order.service.ts");
var routes = [
    {
        path: "",
        children: [
            {
                path: "",
                component: transfer_order_list_component_1.TransferOrderListComponent,
            },
            {
                path: "create",
                component: transfer_order_form_component_1.TransferOrderFormComponent,
            },
            // {
            //   path: "edit/:Id",
...
var TransferOrderModule = /** @class */ (function () {
    ...
    TransferOrderModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                transfer_order_list_component_1.TransferOrderListComponent, transfer_order_form_component_1.TransferOrderFormComponent
            ],
            providers: [
                transfer_order_service_1.TransferOrderService,
...
exports.TransferOrderModule = TransferOrderModule;
