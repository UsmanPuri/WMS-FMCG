...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var shipment_note_manual_service_1 = __webpack_require__(/*! ../services/shipment-note-manual.service */ "./src/app/layout/content/shipment-note-manual/services/shipment-note-manual.service.ts");
...
var ShipmentNoteManualDetailComponent = /** @class */ (function (_super) {
    ...
    ShipmentNoteManualDetailComponent = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.Injector, shipment_note_manual_service_1.ShipmentNoteService,
...
exports.ShipmentNoteManualDetailComponent = ShipmentNoteManualDetailComponent;
...
exports.ShipmentNoteManualEditFormComponent = ShipmentNoteManualEditFormComponent;
...
var ShipmentNoteManualFormComponent = /** @class */ (function (_super) {
    ...
    */
    ...
    ShipmentNoteManualFormComponent = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.Injector, http_1.HttpClient, shipment_note_manual_service_1.ShipmentNoteService, environment_url_service_1.EnvironmentUrlService,
            router_1.ActivatedRoute, ngb_modal_1.ModalManager, common_1.DatePipe,
            excel_file_service_1.ExporterService, ngx_ui_loader_1.NgxUiLoaderService])
    ], ShipmentNoteManualFormComponent);
    return ShipmentNoteManualFormComponent;
}(base_component_1.BaseComponent));
exports.ShipmentNoteManualFormComponent = ShipmentNoteManualFormComponent;
...
exports.ShipmentNoteManualListComponent = ShipmentNoteManualListComponent;
...
var shipment_note_manual_service_1 = __webpack_require__(/*! ./services/shipment-note-manual.service */ "./src/app/layout/content/shipment-note-manual/services/shipment-note-manual.service.ts");
var shipment_note_manual_form_component_1 = __webpack_require__(/*! ./components/shipment-note-manual-form.component */ "./src/app/layout/content/shipment-note-manual/components/shipment-note-manual-form.component.ts");
var shipment_note_manual_list_component_1 = __webpack_require__(/*! ./components/shipment-note-manual-list.component */ "./src/app/layout/content/shipment-note-manual/components/shipment-note-manual-list.component.ts");
var forms_1 = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
...
var ngb_modal_1 = __webpack_require__(/*! ngb-modal */ "./node_modules/ngb-modal/fesm5/ngb-modal.js");
var shipment_note_manual_edit_form_component_1 = __webpack_require__(/*! ./components/shipment-note-manual-edit-form.component */ "./src/app/layout/content/shipment-note-manual/components/shipment-note-manual-edit-form.component.ts");
var shipment_note_manual_detail_component_1 = __webpack_require__(/*! ./components/shipment-note-manual-detail.component */ "./src/app/layout/content/shipment-note-manual/components/shipment-note-manual-detail.component.ts");
var excel_file_service_1 = __webpack_require__(/*! src/app/helpers/services/excel-file.service */ "./src/app/helpers/services/excel-file.service.ts");
...
var routes = [
    {
        ...
        children: [
            {
                path: "",
                component: shipment_note_manual_list_component_1.ShipmentNoteManualListComponent,
            },
            {
                path: "create",
                component: shipment_note_manual_form_component_1.ShipmentNoteManualFormComponent,
            },
            {
                path: "edit/:Id",
                component: shipment_note_manual_edit_form_component_1.ShipmentNoteManualEditFormComponent,
            },
            {
                path: "detail/:Id",
                component: shipment_note_manual_detail_component_1.ShipmentNoteManualDetailComponent,
            },
            {
                path: "**",
                redirectTo: "",
...
var ShipmentNoteManualModule = /** @class */ (function () {
    ...
    ShipmentNoteManualModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                shipment_note_manual_form_component_1.ShipmentNoteManualFormComponent, shipment_note_manual_list_component_1.ShipmentNoteManualListComponent, shipment_note_manual_edit_form_component_1.ShipmentNoteManualEditFormComponent,
                shipment_note_manual_detail_component_1.ShipmentNoteManualDetailComponent
            ],
            providers: [
                shipment_note_manual_service_1.ShipmentNoteService,
...
exports.ShipmentNoteManualModule = ShipmentNoteManualModule;
