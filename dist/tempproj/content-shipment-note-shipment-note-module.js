...
var shipment_note_service_1 = __webpack_require__(/*! ../services/shipment-note.service */ "./src/app/layout/content/shipment-note/services/shipment-note.service.ts");
...
var ShipmentNoteFormComponent = /** @class */ (function (_super) {
    ...
    */
    ...
    ShipmentNoteFormComponent = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.Injector, shipment_note_service_1.ShipmentNoteService,
            router_1.ActivatedRoute, ngb_modal_1.ModalManager])
    ], ShipmentNoteFormComponent);
    return ShipmentNoteFormComponent;
}(base_component_1.BaseComponent));
exports.ShipmentNoteFormComponent = ShipmentNoteFormComponent;
...
exports.ShipmentNoteListComponent = ShipmentNoteListComponent;
...
var shipment_note_service_1 = __webpack_require__(/*! ./services/shipment-note.service */ "./src/app/layout/content/shipment-note/services/shipment-note.service.ts");
var shipment_note_form_component_1 = __webpack_require__(/*! ./components/shipment-note-form.component */ "./src/app/layout/content/shipment-note/components/shipment-note-form.component.ts");
var shipment_note_list_component_1 = __webpack_require__(/*! ./components/shipment-note-list.component */ "./src/app/layout/content/shipment-note/components/shipment-note-list.component.ts");
var forms_1 = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
...
var routes = [
    {
        ...
        children: [
            {
                path: "",
                component: shipment_note_list_component_1.ShipmentNoteListComponent,
            },
            {
                path: "create",
                component: shipment_note_form_component_1.ShipmentNoteFormComponent,
            }, {
                path: "**",
                redirectTo: "",
            }
...
var ShipmentNoteModule = /** @class */ (function () {
    ...
    ShipmentNoteModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                shipment_note_form_component_1.ShipmentNoteFormComponent, shipment_note_list_component_1.ShipmentNoteListComponent
            ],
            providers: [
                shipment_note_service_1.ShipmentNoteService
            ],
            entryComponents: []
        })
    ], ShipmentNoteModule);
...
exports.ShipmentNoteModule = ShipmentNoteModule;
