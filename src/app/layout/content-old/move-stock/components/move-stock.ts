...
@Component({
  ...
  styleUrls: ["../styles/move.stock.scss"],
})
export class MoveStockComponent extends BaseComponent {
...
selectedPallet={};
  constructor(injector: Injector, private _movestockService: MoveStockService,
