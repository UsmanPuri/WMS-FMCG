  ...
  */
  ...
  public shipmentListClip(){
    ...
    if(this.shipmentListToPost.length>0){
      ...
      this.shipmentListToPost.forEach(element =>{
      const index = this.shipmentListToPostTemp.findIndex((e) => e.ItemInformationId == element.ItemInformationId && element.Batch == e.Batch);
      if (index === -1) {
        this.shipmentListToPostTemp.push({
          Batch:element.Batch,
        ...
        this.shipmentListToPostTemp[index].Quantity = this.shipmentListToPostTemp[index].Quantity + element.Quantity;
